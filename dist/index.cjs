...
function formatError(err) {
  ...
  switch (err.kind) {
    case "missing":
      return `  ${pc__default.default.red(icon)} ${pc__default.default.bold(pc__default.default.red(err.key))} ${pc__default.default.dim("\u2192")} ${pc__default.default.red("missing required variable")}`;
    case "invalid_type":
      return [
        `  ${pc__default.default.yellow(icon)} ${pc__default.default.bold(pc__default.default.yellow(err.key))} ${pc__default.default.dim("\u2192")} ${pc__default.default.yellow("invalid type")}`,
        err.received !== void 0 ? `    ${pc__default.default.dim("received:")}  ${pc__default.default.white(err.received)}` : "",
        err.expected !== void 0 ? `    ${pc__default.default.dim("expected:")}  ${pc__default.default.cyan(err.expected)}` : "",
        `    ${pc__default.default.dim("message:")}   ${pc__default.default.white(err.message)}`
      ].filter(Boolean).join("\n");
    case "invalid_format":
    case "invalid_value":
      return [
        `  ${pc__default.default.yellow(icon)} ${pc__default.default.bold(pc__default.default.yellow(err.key))} ${pc__default.default.dim("\u2192")} ${pc__default.default.yellow(err.kind === "invalid_format" ? "invalid format" : "invalid value")}`,
        err.received !== void 0 ? `    ${pc__default.default.dim("received:")}  ${pc__default.default.white(err.received)}` : "",
        err.expected !== void 0 ? `    ${pc__default.default.dim("expected:")}  ${pc__default.default.cyan(err.expected)}` : "",
        `    ${pc__default.default.dim("message:")}   ${pc__default.default.white(err.message)}`
      ].filter(Boolean).join("\n");
...
function formatErrors(errors, source = "env") {
  ...
  lines.push("");
  lines.push(
    pc__default.default.bold(pc__default.default.red(`  ${ICONS.error} env-guardian: Validation failed`)) + pc__default.default.dim(` (${errors.length} error${errors.length !== 1 ? "s" : ""})`)
  );
  lines.push(pc__default.default.dim(`  Source: ${source}`));
  lines.push("");
  if (missing.length > 0) {
    lines.push(pc__default.default.bold(pc__default.default.dim(`  \u2500\u2500 Missing Variables (${missing.length}) \u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500`)));
  ...
  if (invalid.length > 0) {
    lines.push(pc__default.default.bold(pc__default.default.dim(`  \u2500\u2500 Invalid Variables (${invalid.length}) \u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500`)));
    for (const err of invalid) {
      lines.push(formatError(err));
    }
    lines.push("");
  }
  lines.push(pc__default.default.dim("  \u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500"));
  lines.push(
    pc__default.default.dim("  Fix the above errors in your ") + pc__default.default.cyan(".env") + pc__default.default.dim(" file or environment and restart.")
  );
  lines.push("");
  return lines.join("\n");
}
function formatSuccess(count, source = "env") {
  return [
    "",
    `  ${pc__default.default.green(ICONS.success)} ${pc__default.default.bold(pc__default.default.green("env-guardian: All variables valid"))} ${pc__default.default.dim(`(${count} checked)`)}`,
    pc__default.default.dim(`  Source: ${source}`),
    ""
  ].join("\n");
}
